...
_Note: `nvm install` will automatically read the project's `.nvmrc` and install/switch to Node v22._
...
_Ensure that `DEVELOPMENT_MODE=true` and `NEXT_PUBLIC_DEVELOPMENT_MODE=true` are active to bypass external Firebase auth._
