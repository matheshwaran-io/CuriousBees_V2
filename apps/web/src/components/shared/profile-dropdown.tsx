          ...
          >
            ...
            <div className="p-3.5 bg-gradient-to-br from-slate-50 to-blue-50/30 rounded-2xl border border-slate-100/80 mb-2">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-10 h-10 rounded-full bg-slate-100 overflow-hidden shrink-0 border-2 border-white shadow-sm flex items-center justify-center">
              ...
              {currentUser.role === 'RESEARCH_SUPERVISOR' && (
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <GraduationCap className="w-4 h-4 text-[#0C4DA2] group-hover:scale-110 transition-transform" />
                    <span className="font-extrabold text-[#0C4DA2]">Supervision Panel</span>
                  </div>
                  <ChevronRight className="w-3.5 h-3.5 text-[#0C4DA2] group-hover:translate-x-0.5 transition-all" />
                </button>
              )}
