        ...
        <div className="w-full max-w-md relative z-10">
          ...
          >
            ...
            <div className="text-center space-y-6">
              <div>
                <h1 className="text-xl font-bold text-white tracking-tight">Account Registration</h1>
                <p className="text-white/40 text-xs mt-2 leading-relaxed font-sans">
                  Self-registration is disabled. Access is restricted to pre-authorized accounts. If your account has been pre-provisioned, please sign in with your Google account.
                </p>
              </div>
